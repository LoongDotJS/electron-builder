import { Arch, CopyFileTransformer, exists, FileTransformer, InvalidConfigurationError, log, walk } from "@loongdotjs/builder-util"
          ...
          switch (name) {
            case "squirrel":
              try {
                ...
                throw new InvalidConfigurationError(`Module @loongdotjs/electron-builder-squirrel-windows must be installed in addition to build Squirrel.Windows: ${e.stack || e}`)
              }
