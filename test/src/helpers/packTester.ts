import { PublishManager } from "@loongdotjs/app-builder-lib"
import { verifyAsarFileTree as _verifyAsarFileTree } from "./asarVerifier"
import { computeArchToTargetNamesMap } from "@loongdotjs/app-builder-lib/out/targets/targetFactory"
import { getLinuxToolsPath } from "@loongdotjs/app-builder-lib/out/toolsets/linux"
import { parsePlistFile, PlistObject } from "@loongdotjs/app-builder-lib/out/util/plist"
import { AsarIntegrity } from "@loongdotjs/app-builder-lib/out/asar/integrity"
import { addValue, copyDir, deepAssign, exec, executeFinally, exists, FileCopier, log, USE_HARD_LINKS, walk } from "@loongdotjs/builder-util"
import { CancellationToken, UpdateFileInfo } from "builder-util-runtime"
import { Arch, ArtifactCreated, Configuration, DIR_TARGET, getArchSuffix, MacOsTargetName, Packager, PackagerOptions, Platform, Target } from "@loongdotjs/electron-builder"
import { convertVersion } from "@loongdotjs/electron-winstaller"
...
import { getCollectorByPackageManager, PM } from "@loongdotjs/app-builder-lib/out/node-module-collector"
...
import { computeDefaultAppDirectory } from "@loongdotjs/app-builder-lib/out/util/config/config"
import { installDependencies } from "@loongdotjs/app-builder-lib/out/util/yarn"
import { ELECTRON_VERSION } from "./testConfig"
import { createLazyProductionDeps } from "@loongdotjs/app-builder-lib/out/util/packageDependencies"
import { execSync } from "child_process"
import { detectPackageManager } from "@loongdotjs/app-builder-lib/out/node-module-collector/packageManager"
